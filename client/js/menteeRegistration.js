...
document.getElementById('gender-other').addEventListener('change', function() {
    var otherGenderInput = document.getElementById('other-gender-input');
    otherGenderInput.style.display = this.checked ? 'inline-block' : 'none';
});